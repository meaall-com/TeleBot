"""@مرافق التلغراف
الأوامر المتوفرة:
.telegraph وسائل الإعلام ردا على وسائل الإعلام
.telegraph نص كرد على نص كبير"""
...
async def _(event):
    ...
    if BOTLOG:
        ...
        "تم إنشاء حساب Telegraph جديد {} للدورة الحالية. \ n ** لا تعط عنوان url هذا لأي شخص ، حتى لو قال إنه من Telegram! **".format(auth_url)
         )
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("قم بالرد على رسالة للحصول على رابط telegra.ph دائم. (من وحي أبو العباس الوشلي)")
